...
class EuclideanDistTracker:
    ...
    def capture(self,img,x,y,h,w,sp,id):
        if(self.capf[id]==0):
            ...
            if(sp>limit):
                ...
                filet.write(str(id)+" \t "+str(sp)+"<----EXCEEDED THE SPEED LIMIT\n")
                self.exceeded+=1
            else:
    ...
    def end(self):
        ...
        file.write("\n---------------------------\n")
        file.write("---------------------------\n")
        file.write("_______TOTAL SUMMARY_______\n")
        file.write("---------------------------\n")
        file.write("---------------------------\n")
        file.write(" Total Vehicles :\t"+str(self.count)+"\n")
        file.write(" Total Vehicles that Exceeded speed limit =>\t"+str(self.exceeded))
        file.close()
